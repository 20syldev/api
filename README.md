<div align="center">
  ...
  # API Personnelle
  [![Version](https://custom-icon-badges.demolab.com/badge/Version%20:-v4.3.0-6479ee?logo=api.sylvain.sh&labelColor=23272A)](https://github.com/20syldev/api/releases/latest)
</div>
...
```
```console
> @20syldev/api@4.3.0 build
> tsc

> @20syldev/api@4.3.0 start
> node dist/app.js
