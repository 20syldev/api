...
[![Version](https://custom-icon-badges.demolab.com/badge/Version%20:-v5.4.0-6479ee?logo=api.sylvain.sh&labelColor=23272A)](https://github.com/20syldev/api/releases/latest)
...
```console
> @20syldev/api@5.4.0 build
> tsc

> @20syldev/api@5.4.0 start
> node dist/app.js
