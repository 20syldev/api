...
[![Version](https://custom-icon-badges.demolab.com/badge/Version%20:-v5.5.0-6479ee?logo=api.sylvain.sh&labelColor=23272A)](https://github.com/20syldev/api/releases/latest)
...
```console
> @20syldev/api@5.5.0 build
> tsc

> @20syldev/api@5.5.0 start
> node dist/app.js
